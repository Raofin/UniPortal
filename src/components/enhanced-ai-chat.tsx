...
export const EnhancedAIChat: React.FC = () => {
  ...
  return (
    <div className="flex h-full w-full">
      ...
      <div className="w-1/4 border-r border-divider overflow-y-auto flex flex-col">
        ...
        <div className="flex-grow overflow-y-auto">
          {threads.map((thread) => (
            <motion.div
              ...
              className={`p-3 cursor-pointer border-b border-divider ${
                selectedThread === thread.id ? "bg-content1" : ""
              }`}
            ...
            >
              <div className="flex items-center gap-2">
                <Icon 
                  ...
                  className={selectedThread === thread.id ? "text-primary" : "text-default-500"} 
                />
        ...
        <div className="flex-grow overflow-y-auto p-4 space-y-6">
          {currentThread.messages.length === 0 ? (
            <div className="flex flex-col items-center justify-center h-full text-center">
              <Icon icon="lucide:bot" className="w-16 h-16 text-primary-200 mb-4" />
              <h3 className="text-xl font-medium mb-2">How can I help you today?</h3>
              <p className="text-default-500 max-w-md mb-4">
                Ask me about your coursework, assignments, or uploaded notes. I can help explain concepts, provide examples, or guide you through problem-solving.
              </p>
                  ...
                  <div className={`flex items-start gap-3 max-w-[80%] ${message.role === "user" ? "flex-row-reverse" : ""}`}>
                    ...
                    <div className={`rounded-lg p-4 ${
                      ...
                      <div className="flex justify-between items-center mb-1">
                        ...
                        <span className="text-xs text-default-400 ml-4">
