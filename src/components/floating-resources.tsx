                  ...
                  <div className="w-1/4 border-r border-divider p-4">
                    ...
                    <div className="mb-2 flex justify-between items-center">
                      ...
                      <Button
                        ...
                        variant="light"
                        isIconOnly
                        onPress={() => setIsAddingSectionModalOpen(true)}
                      >
                      ...
                      {filteredFiles.length > 0 ? (
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                          {filteredFiles.map((file, index) => (
                            ...
                            >
                              <Card shadow="sm" className="border border-divider hover:border-primary transition-colors">
                                      ...
                                      <div className="flex gap-1 mt-2">
                                        ...
                                        <Dropdown>
                                          ...
                                          <DropdownMenu aria-label="File actions">
                                            <DropdownItem startContent={<Icon icon="lucide:edit" size={16} />}>
                                              Rename
                                            </DropdownItem>
