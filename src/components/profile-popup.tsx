          ...
          <div className="p-4">
            <div className="flex justify-between items-center mb-2">
              ...
              <div className="flex items-baseline gap-1">
                <span className="font-semibold text-lg">{studentData.cgpa}</span>
                <span className="text-xs text-default-500">/ {studentData.maxCgpa}</span>
              </div>
            </div>
            
            <Progress 
              value={(studentData.cgpa / studentData.maxCgpa) * 100} 
              color="success"
              className="mb-4"
              size="sm"
            />
            ...
            <div className="flex justify-between items-center mb-2">
              ...
              <div className="flex items-baseline gap-1">
                <span className="font-semibold text-lg">{studentData.creditsCompleted}</span>
                <span className="text-xs text-default-500">/ {studentData.totalCredits}</span>
              </div>
            </div>
            
            <Progress 
              value={(studentData.creditsCompleted / studentData.totalCredits) * 100} 
              color="primary"
              className="mb-4"
              size="sm"
            />
          ...
          <div className="p-4 flex justify-between items-center">
            ...
            <div className="flex gap-2">
              ...
              <Button
                ...
                variant="flat"
                color="danger"
                startContent={<Icon icon="lucide:log-out" size={16} />}
              >
                Logout
              </Button>
            </div>
